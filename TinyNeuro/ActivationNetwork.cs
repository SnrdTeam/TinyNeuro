...
namespace TinyNeuro
{
    ...
    public class ActivationNetwork : Network
    {
        ...
        private ActivationNetwork() : base()
        {
        ...
        public static ActivationNetwork Deserialize(string serializedNetwork)
        {
            return DeserializeFromJson(JObject.Parse(serializedNetwork));
        }
    }
}
